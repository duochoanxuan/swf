...
Game.confirmRestart = function() {
	Popup.confirm('Bạn có chắc chắn muốn bắt đầu lại không?', null, Game.restart);
	Game.removeHint();
};
...
Game.endLevel = function() {
	Popup.alert('Cấp độ ' + Game.level + ' hoàn thành !', Game.nextLevel);
	Game.removeHint();
}
...
Game.gameOver = function() {
	Popup.confirm('Không còn khả năng di chuyển nào nữa.<br/>Bạn có muốn bắt đầu lại không?', null, Game.restart);
	Game.paused = true;
};