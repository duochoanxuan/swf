...
function Popup (args) {
	if (args.type == undefined)
		throw new Error('Thiếu thuộc tính "type" trong đối tượng đối số');
	if (args.content == undefined)
		throw new Error('Thiếu thuộc tính "content" trong đối tượng đối số');
	...
	if (args.type === 'text') {
		...
		throw new Error('Lỗi: thuộc tính "type" trong đối tượng đối số phải là chuỗi ("text" or "html"), ' + args.type + ':' + typeof args.type + ' được đưa ra thay thế.');
	}
